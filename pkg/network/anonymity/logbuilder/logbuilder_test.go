...
const (
	...
	tcFmtLog  = "service=TST type=ENQRQ hash=96CB1F09...6A9B130B addr=B6E23126...55F22714 proof=0000012345 size=1024B conn=127.0.0.1:"
)
...
func TestLogger(t *testing.T) {
	...
	if logger.Get(CLogBaseEnqueueRequest) != tcFmtLog {
