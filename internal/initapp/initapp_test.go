...
const (
	...
	tcPassword    = "3e0bc08f73fe2cd00a4dac7b5d31bd24dfada10ada270c4691e964a5b2924cd6" // nolint: gosec
...
func TestGetPrivKeyAsPassword(t *testing.T) {
	...
	password, err := GetPassword(tcPrivKey1024Path, "service-name")
	if err != nil {
		t.Error(err)
		return
	}
	...
	if _, err := GetPassword("./random/not_exist/path/57199u140291724y121291d1/priv.key", "service-name"); err == nil {
