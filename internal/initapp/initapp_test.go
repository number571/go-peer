...
const (
	...
	tcPassword    = "4ec0aae41c69e98c349a6dcd8f9fcfc5173e27d8b862609acce01bee5bf86817" // nolint: gosec
...
func TestGetPrivKeyAsPassword(t *testing.T) {
	...
	password, err := GetPrivKeyAsPassword(tcPrivKey1024Path, "service-name")
	if err != nil {
		t.Error(err)
		return
	}
	...
	if _, err := GetPrivKeyAsPassword(tcInvalidPrivKey1024Path, "service-name"); err == nil {
		t.Error("success get invalid private key")
		return
	}
	if _, err := GetPrivKeyAsPassword("./random/not_exist/path/57199u140291724y121291d1/priv.key", "service-name"); err == nil {
