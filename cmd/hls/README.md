...
```
1. GET/PUT/DELETE /api/config/connects
2. GET/PUT/DELETE /api/config/friends
...
```bash
curl -i -X PUT -H 'Accept: application/json' http://localhost:7572/api/config/connects --data '{"connect":"localhost:8888"}'
```
