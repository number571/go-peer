...
import (
	...
	hla_settings "github.com/number571/go-peer/cmd/hidden_lake/adapters/chatingar/producer/pkg/settings"
)
...
func TestInit(t *testing.T) {
	...
	if config1.GetConnection().GetPostID() != tcAddress1 {
	...
	if config2.GetConnection().GetPostID() != tcAddress1 {
	...
	if config3.GetConnection().GetPostID() != hla_settings.CDefaultPostID {
